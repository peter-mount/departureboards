...
public class DarwinPushPort
{
    ...
    void start()
    {
        ...
        // Force messages to remain alive for 10 minutes
        Map<String, Object> properties = RabbitMQ.queueTTL( 600000L );
        
        rabbit.queueDurableConsumer( "db.nre", "nre.push", properties, Function.identity(), this::parseXML );
    }

    private void parseXML( byte msg[] )
    {
        try {
